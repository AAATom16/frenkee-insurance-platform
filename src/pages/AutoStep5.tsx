    ...
    <div className="bg-white flex flex-col gap-[24px] items-center p-[24px] w-full min-h-screen">
      ...
      <div className="flex flex-col gap-[24px] items-center overflow-clip px-[99px] py-[24px] relative w-[1000px] max-w-full">
        ...
        <div className="flex items-center justify-center gap-[12px] relative w-full">
          ...
          <div className="flex flex-col items-center gap-[8px]">
            <div className="bg-[#3f2578] flex items-center justify-center rounded-full size-[40px]">
              <span className="text-white font-['Mona_Sans_VF:Bold',sans-serif] text-[16px]">5</span>
            </div>
            <span className="text-[#3f2578] font-['Mona_Sans_VF:Bold',sans-serif] text-[14px]">Shrnutí</span>
          </div>
        </div>
        ...
        <div className="flex items-start relative w-full">
          <div className="bg-white border border-[#edf2f7] border-solid flex flex-[1_0_0] items-start min-h-px min-w-px p-[16px] relative rounded-[12px]">
            <div className="flex flex-[1_0_0] flex-col gap-[12px] min-h-px min-w-px relative">
              <div className="flex flex-col font-['Mona_Sans_VF:Bold',sans-serif] justify-center leading-[0] not-italic relative text-[20px] text-[#3f2578]">
                <p className="leading-[1.6]">Vozidlo</p>
              </div>
              <div className="flex justify-between items-center">
                <span className="font-['Mona_Sans_VF:Bold',sans-serif] text-[14px] text-[#94a3b8]">SPZ:</span>
                <span className="font-['Mona_Sans_VF:Bold',sans-serif] text-[14px] text-[#3f2578]">1A2 3456</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="font-['Mona_Sans_VF:Bold',sans-serif] text-[14px] text-[#94a3b8]">Značka a model:</span>
                <span className="font-['Mona_Sans_VF:Bold',sans-serif] text-[14px] text-[#3f2578]">Škoda Octavia</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="font-['Mona_Sans_VF:Bold',sans-serif] text-[14px] text-[#94a3b8]">Rok výroby:</span>
                <span className="font-['Mona_Sans_VF:Bold',sans-serif] text-[14px] text-[#3f2578]">2020</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-start relative w-full">
          <div className="bg-white border border-[#edf2f7] border-solid flex flex-[1_0_0] items-start min-h-px min-w-px p-[16px] relative rounded-[12px]">
            <div className="flex flex-[1_0_0] flex-col gap-[12px] min-h-px min-w-px relative">
              ...
              <div className="flex justify-between items-center">
                <span className="font-['Mona_Sans_VF:Bold',sans-serif] text-[14px] text-[#94a3b8]">Pojišťovna:</span>
                <span className="font-['Mona_Sans_VF:Bold',sans-serif] text-[14px] text-[#3f2578]">Kooperativa</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="font-['Mona_Sans_VF:Bold',sans-serif] text-[14px] text-[#94a3b8]">Typ:</span>
                <span className="font-['Mona_Sans_VF:Bold',sans-serif] text-[14px] text-[#3f2578]">Povinné ručení + Havarijní</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="font-['Mona_Sans_VF:Bold',sans-serif] text-[14px] text-[#94a3b8]">Limit plnění:</span>
                <span className="font-['Mona_Sans_VF:Bold',sans-serif] text-[14px] text-[#3f2578]">50 mil. Kč</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="font-['Mona_Sans_VF:Bold',sans-serif] text-[14px] text-[#94a3b8]">Spoluúčast:</span>
                <span className="font-['Mona_Sans_VF:Bold',sans-serif] text-[14px] text-[#3f2578]">5 000 Kč</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-start relative w-full">
          <div className="bg-white border border-[#edf2f7] border-solid flex flex-[1_0_0] items-start min-h-px min-w-px p-[16px] relative rounded-[12px]">
            <div className="flex flex-[1_0_0] flex-col gap-[12px] min-h-px min-w-px relative">
              ...
              <div className="flex justify-between items-center">
                <span className="font-['Mona_Sans_VF:Bold',sans-serif] text-[14px] text-[#94a3b8]">Jméno a příjmení:</span>
                <span className="font-['Mona_Sans_VF:Bold',sans-serif] text-[14px] text-[#3f2578]">Jan Novák</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="font-['Mona_Sans_VF:Bold',sans-serif] text-[14px] text-[#94a3b8]">E-mail:</span>
                <span className="font-['Mona_Sans_VF:Bold',sans-serif] text-[14px] text-[#3f2578]">jan.novak@email.cz</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="font-['Mona_Sans_VF:Bold',sans-serif] text-[14px] text-[#94a3b8]">Telefon:</span>
                <span className="font-['Mona_Sans_VF:Bold',sans-serif] text-[14px] text-[#3f2578]">+420 123 456 789</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-start relative w-full">
          <div className="bg-[#f8fafc] flex flex-[1_0_0] flex-col gap-[12px] min-h-px min-w-px p-[16px] relative rounded-[12px]">
            ...
            <label className="flex items-start gap-[12px] cursor-pointer">
              ...
              />
              <span className="font-['Mona_Sans_VF:Bold',sans-serif] text-[14px] text-[#3f2578]">
        ...
        <div className="flex items-start relative w-full">
          <div className="bg-white border-2 border-[#3f2578] flex flex-[1_0_0] items-center justify-between min-h-px min-w-px p-[20px] relative rounded-[12px]">
            ...
            <div className="flex flex-col items-end gap-[4px]">
              <div className="flex flex-col font-['Mona_Sans_VF:Bold',sans-serif] justify-center leading-[0] not-italic relative text-[36px] text-[#3f2578]">
                <p className="leading-[1.2]">2 890 Kč</p>
              </div>
              <div className="flex flex-col font-['Mona_Sans_VF:Bold',sans-serif] justify-center leading-[0] not-italic relative text-[16px] text-[#94a3b8]">
