        ...
        <div className="flex flex-col gap-[8px] items-start relative w-full">
          ...
          <div className="flex gap-[24px] items-center relative w-full">
            ...
            >
              ...
              <div className="flex flex-col font-['Mona_Sans_VF:Bold',sans-serif] justify-center leading-[0] not-italic relative text-[#3f2578] text-[16px] text-center whitespace-nowrap">
            ...
            >
              ...
              <div className="flex flex-col font-['Mona_Sans_VF:Bold',sans-serif] justify-center leading-[0] min-w-full not-italic relative text-[#3f2578] text-[16px] text-center w-[min-content]">
        ...
        <div className="flex gap-[12px] items-start relative w-full">
          <div className="flex flex-[1_0_0] flex-col gap-[8px] items-start min-h-px min-w-px relative">
            ...
            <div className="bg-white border border-[#e2e9f0] border-solid flex gap-[8px] h-[40px] items-center overflow-clip pl-[4px] pr-[8px] py-[4px] relative rounded-[8px] shadow-[0px_0.301px_0.51px_0px_rgba(0,0,0,0.06),0px_1.144px_2.72px_0px_rgba(0,0,0,0.02)] w-full">
              ...
              >
                <div className={`flex flex-[1_0_0] flex-col font-['Mona_Sans_VF:Bold',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[14px] text-center ${
        ...
        <div className="flex flex-col items-start relative w-full">
          <div className="flex flex-col gap-[8px] items-start relative w-full">
            ...
            <input
              ...
              placeholder="Stát"
              className="bg-white border border-[#e2e9f0] border-solid flex gap-[8px] h-[40px] items-center overflow-clip px-[12px] relative rounded-[8px] shadow-[0px_0.301px_0.51px_0px_rgba(0,0,0,0.06),0px_1.144px_2.72px_0px_rgba(0,0,0,0.02)] w-full font-['Mona_Sans_VF:Bold',sans-serif] text-[14px] text-[#94a3b8] outline-none"
            />
            <div className="flex gap-[8px] items-start relative w-full">
              <input
                ...
                placeholder="Město"
                className="bg-white border border-[#e2e9f0] border-solid flex flex-[1_0_0] gap-[8px] h-[40px] items-center overflow-clip px-[12px] relative rounded-[8px] shadow-[0px_0.301px_0.51px_0px_rgba(0,0,0,0.06),0px_1.144px_2.72px_0px_rgba(0,0,0,0.02)] font-['Mona_Sans_VF:Bold',sans-serif] text-[14px] text-[#94a3b8] outline-none"
              />
              <input
                type="text"
                value={zipCode}
