          ...
          <div className="flex flex-[1_0_0] flex-col gap-[8px] items-start min-h-px min-w-px relative">
            ...
            <div className="bg-white border border-[#e2e9f0] border-solid flex gap-[8px] h-[40px] items-center overflow-clip px-[12px] relative rounded-[8px] shadow-[0px_0.301px_0.51px_0px_rgba(0,0,0,0.06),0px_1.144px_2.72px_0px_rgba(0,0,0,0.02)] w-full">
              <input
                ...
                placeholder="0"
                className="flex flex-[1_0_0] font-['Mona_Sans_VF:Bold',sans-serif] text-[14px] text-[#94a3b8] bg-transparent border-none outline-none"
              />
              <span className="font-['Mona_Sans_VF:Bold',sans-serif] text-[14px] text-[#3f2578]">m²</span>
            </div>
          </div>
          ...
          <div className="flex flex-[1_0_0] flex-col gap-[8px] items-start min-h-px min-w-px relative">
            ...
            <div className="bg-white border border-[#e2e9f0] border-solid flex gap-[8px] h-[40px] items-center overflow-clip px-[12px] relative rounded-[8px] shadow-[0px_0.301px_0.51px_0px_rgba(0,0,0,0.06),0px_1.144px_2.72px_0px_rgba(0,0,0,0.02)] w-full">
              <input
                ...
                className="flex flex-[1_0_0] font-['Mona_Sans_VF:Bold',sans-serif] text-[14px] text-[#94a3b8] bg-transparent border-none outline-none"
              />
              <span className="font-['Mona_Sans_VF:Bold',sans-serif] text-[14px] text-[#3f2578]">Kč</span>
            </div>
          </div>
        </div>
